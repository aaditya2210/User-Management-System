...
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-primary" style="font-size: 1.8rem;">Customer Management</h2>
                ...
                success: function(response) {
                    ...
                    if (response.links && response.links.length > 3) {
                        paginationLinks.append(
                            `<nav aria-label="Customer pagination"><ul class="pagination pagination-sm mb-0"></ul></nav>`
                            );
            ...
            function exportData(format) {
                ...
                $.ajax({
                    ...
                    success: function(response, status, xhr) {
                        let filename = xhr.getResponseHeader('Content-Disposition')?.split('filename=')[
                            1] || `customers.${format}`;
                    ...
                    complete: function() {
                        setTimeout(() => {
                            ...
                            button.html(
                                `<i class="fas fa-${icons[format]} me-1"></i> ${format.toUpperCase()}`
                                );
                        }, 1500);
                    }
                });
